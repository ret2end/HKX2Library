...
namespace HKX2
{
    ...
    public partial class hkpWorld : hkReferencedObject
    {
        ...
        public List<dynamic> m_activeSimulationIslands = new List<dynamic>();
        public List<dynamic> m_inactiveSimulationIslands = new List<dynamic>();
        public List<dynamic> m_dirtySimulationIslands = new List<dynamic>();
        ...
        public List<dynamic> m_actionListeners = new List<dynamic>();
        public List<dynamic> m_entityListeners = new List<dynamic>();
        public List<dynamic> m_phantomListeners = new List<dynamic>();
        public List<dynamic> m_constraintListeners = new List<dynamic>();
        public List<dynamic> m_worldDeletionListeners = new List<dynamic>();
        public List<dynamic> m_islandActivationListeners = new List<dynamic>();
        public List<dynamic> m_worldPostSimulationListeners = new List<dynamic>();
        public List<dynamic> m_worldPostIntegrateListeners = new List<dynamic>();
        public List<dynamic> m_worldPostCollideListeners = new List<dynamic>();
        public List<dynamic> m_islandPostIntegrateListeners = new List<dynamic>();
        public List<dynamic> m_islandPostCollideListeners = new List<dynamic>();
        public List<dynamic> m_contactListeners = new List<dynamic>();
        public List<dynamic> m_contactImpulseLimitBreachedListeners = new List<dynamic>();
        public List<dynamic> m_worldExtensions = new List<dynamic>();
        ...
        public override void ReadXml(XmlDeserializer xd, XElement xe)
        {
            ...
            m_fixedIsland = default;
            m_fixedRigidBody = xd.ReadClassPointer<hkpRigidBody>(xe, nameof(m_fixedRigidBody));
            m_activeSimulationIslands = default;
            m_inactiveSimulationIslands = default;
            m_dirtySimulationIslands = default;
            m_maintenanceMgr = default;
            m_memoryWatchDog = default;
            m_assertOnRunningOutOfSolverMemory = default;
            m_broadPhase = default;
            m_kdTreeManager = default;
            m_autoUpdateTree = xd.ReadBoolean(xe, nameof(m_autoUpdateTree));
            m_broadPhaseDispatcher = default;
            m_phantomBroadPhaseListener = default;
            m_entityEntityBroadPhaseListener = default;
            m_broadPhaseBorderListener = default;
            m_multithreadedSimulationJobData = default;
            m_collisionInput = default;
            m_collisionFilter = default;
            m_collisionDispatcher = default;
            m_convexListFilter = default;
            m_pendingOperations = default;
            m_pendingOperationsCount = xd.ReadInt32(xe, nameof(m_pendingOperationsCount));
            m_pendingBodyOperationsCount = default;
            ...
            m_pendingOperationQueues = default;
            ...
            m_modifyConstraintCriticalSection = default;
            m_isLocked = xd.ReadInt32(xe, nameof(m_isLocked));
            m_islandDirtyListCriticalSection = default;
            m_propertyMasterLock = default;
            m_wantSimulationIslands = xd.ReadBoolean(xe, nameof(m_wantSimulationIslands));
            m_useHybridBroadphase = default;
            ...
            m_actionListeners = default;
            m_entityListeners = default;
            m_phantomListeners = default;
            m_constraintListeners = default;
            m_worldDeletionListeners = default;
            m_islandActivationListeners = default;
            m_worldPostSimulationListeners = default;
            m_worldPostIntegrateListeners = default;
            m_worldPostCollideListeners = default;
            m_islandPostIntegrateListeners = default;
            m_islandPostCollideListeners = default;
            m_contactListeners = default;
            m_contactImpulseLimitBreachedListeners = default;
            m_worldExtensions = default;
            m_violatedConstraintArray = default;
            m_broadPhaseBorder = default;
            ...
            m_contactPointGeneration = default;
        }
