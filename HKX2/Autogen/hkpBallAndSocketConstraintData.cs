...
namespace HKX2
{
    ...
    // m_atoms m_class: hkpBallAndSocketConstraintDataAtoms Type.TYPE_STRUCT Type.TYPE_VOID arrSize: 0 offset: 32 flags: ALIGN_8|FLAGS_NONE enum: 
    
    public class hkpBallAndSocketConstraintData : hkpConstraintData
    {

        public hkpBallAndSocketConstraintDataAtoms/*struct void*/ m_atoms;
